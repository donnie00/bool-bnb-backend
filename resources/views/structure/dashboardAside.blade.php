    <aside class="navigation top-0 bottom-0 start-0">
       ...
       <ul class=" top-0 start-0 w-100 ps-1 d-flex flex-column">
          ...
          <li id="profile" class="  list w-100  d-block">
             <b></b>
             <b></b>
             <a class="p-relative w-100 text-decoration-none " href="{{ route('Admin.dashboard') }}">
                <span class="icon text-cemter pt-2 d-block ">
          ...
          <li id="apartments" class="list w-100 ">
             <b></b>
             <b></b>
             <a class="p-relative w-100 text-decoration-none " href="{{ route('Admin.apartments.index') }}">
                <span class="icon text-cemter pt-2 d-block">
          ...
          <li id="messages" class="list w-100 ">
             <b></b>
             <b></b>
             <a class="p-relative w-100 text-decoration-none " href="{{ route('Admin.dashboard.messages') }}">
                <span class="icon text-cemter pt-2 d-block">
